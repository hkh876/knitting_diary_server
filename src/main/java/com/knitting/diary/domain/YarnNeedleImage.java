...
@Entity
@Table(name = "yarn_needle_image")
@Getter
@DynamicUpdate
@NoArgsConstructor(access = AccessLevel.PROTECTED)
public class YarnNeedleImage extends BaseEntity {
    @Id
    ...
    @Builder
    public YarnNeedleImage(Long id, String filePath, String fileName, Knitting knitting) {
        this.id = id;
